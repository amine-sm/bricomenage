          ...
          <div className="flex min-h-[78px] items-center justify-between gap-3">
            ...
            >
              <motion.span
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm sm:h-12 sm:w-12"
              >
                <img
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <Link
                href="/panier"
                className="group relative hidden h-12 items-center gap-2 rounded-2xl bg-orange-500 px-4 font-black text-white shadow-lg shadow-orange-500/20 transition hover:-translate-y-0.5 hover:bg-orange-600 sm:flex"
              >
        ...
        >
          {mobileOpen && (
            <motion.div
              ...
              className="fixed inset-x-0 bottom-[76px] top-0 z-[110] overflow-y-auto overscroll-contain bg-white lg:hidden"
            >
              <div className="min-h-full px-4 pb-8 pt-3 sm:px-6">

                {/* HEADER MENU */}

                <div className="sticky top-0 z-20 -mx-4 mb-3 flex items-center justify-between border-b border-zinc-100 bg-white/95 px-4 py-3 backdrop-blur sm:-mx-6 sm:px-6">
                  <Link
                    href="/"
                ...
                <button
                  ...
                  className="mt-3 flex w-full items-center gap-3 rounded-2xl bg-zinc-950 px-4 py-4 text-sm font-black text-white"
                >
      ...
      >
        ...
        >
          ...
          <Link
            ...
            className={`relative flex h-[72px] flex-col items-center justify-center gap-1 ${
              isActive("/")
                ? "text-orange-500"
                : "text-zinc-400"
            }`}
          >
            {isActive("/") && (
              <motion.span
                ...
                className="absolute top-1 h-1 w-6 rounded-full bg-orange-500"
              />
            )}
