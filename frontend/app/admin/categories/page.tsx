      ...
      <div className="space-y-7">
        ...
        <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
          ...
          <StatCard
            ...
            description="Avec une description complète"
  ...
  return (
    <article className="group relative flex h-full flex-col overflow-hidden rounded-[28px] border border-zinc-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1.5 hover:border-orange-200 hover:shadow-[0_22px_55px_rgba(24,24,27,0.12)]">
      ...
      <div className="flex flex-1 flex-col p-5">
        <span className="truncate text-[10px] font-black uppercase tracking-[0.14em] text-orange-500">
        ...
        <code className="mt-2 inline-flex w-fit max-w-full truncate rounded-lg bg-zinc-100 px-2.5 py-1.5 text-[10px] font-bold text-zinc-500">
          {category.slug}
        </code>
...
function CategoryModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] overflow-y-auto bg-zinc-950/55 p-4 backdrop-blur-sm">
      <form
        onSubmit={onSubmit}
        className="mx-auto my-6 w-full max-w-2xl overflow-hidden rounded-[30px] bg-white shadow-2xl"
      >
...
function CategoryPreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-[110] overflow-y-auto bg-zinc-950/55 p-4 backdrop-blur-sm">
      <div className="mx-auto my-8 w-full max-w-xl overflow-hidden rounded-[30px] bg-white shadow-2xl">
