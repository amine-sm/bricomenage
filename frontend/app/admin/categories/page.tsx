          ...
          {loading ? (
            ...
            <>
              ...
              "table" ? (
                ...
                <div className="flex snap-x snap-mandatory items-stretch gap-4 overflow-x-auto p-4 pb-6 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden md:grid md:grid-cols-2 md:gap-5 md:overflow-visible md:snap-none lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                  {paginatedItems.map(
                    (category) => (
                      <CategoryMobileCard
                        key={category.id}
